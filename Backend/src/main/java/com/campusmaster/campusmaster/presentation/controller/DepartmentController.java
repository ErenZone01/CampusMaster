...
public class DepartmentController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'TEACHER', 'STUDENT')")
    @Operation(summary = "Détails d'un département", description = "Récupérer un département par son ID")
    ...
    @Operation(summary = "Créer un département", description = "Créer un nouveau département (Admin uniquement)")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Modifier un département", description = "Modifier un département existant (Admin uniquement)")
    public ResponseEntity<?> updateDepartment(@PathVariable Long id, @Valid @RequestBody UpdateDepartmentRequest request) {
        return departmentRepository.findById(id)
                .map(department -> {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Supprimer un département", description = "Supprimer un département (Admin uniquement)")
