...
public class UserController {
        ...
        switch (request.getRole()) {
            ...
            case STUDENT:
                if (request.getDateOfBirth() == null) {
                    throw new IllegalArgumentException("La date de naissance est obligatoire pour un étudiant");
                }
                if (request.getDepartmentId() == null) {
                    throw new IllegalArgumentException("Le département est obligatoire pour un étudiant");
                }
    ...
    @GetMapping
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Liste des utilisateurs", description = "Récupérer tous les utilisateurs avec pagination et filtres")
    ...
    @Operation(summary = "Détails utilisateur", description = "Récupérer les informations d'un utilisateur par son ID")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Supprimer utilisateur", description = "Désactiver un utilisateur (soft delete)")
