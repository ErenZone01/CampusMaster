...
public class ModuleServiceImpl implements ModuleService {
    ...
    public ModuleResponse createModule(CreateModuleRequest request) {
        ...
        return ModuleResponse.builder()
                ...
                .teacherIds(
                        saved.getTeachers() != null
                                ? saved.getTeachers().stream().map(t -> t.getId()).toList()
                                : List.of())
                .build();
    }
    ...
    public ModuleResponse updateModule(Long id, CreateModuleRequest module) {
        ...
        if (module.getSemester() != Semester.SEMESTER_1
                && module.getSemester() != Semester.SEMESTER_2) {
    ...
    public ModuleResponse getModuleById(Long id) {
        ...
        return ModuleResponse.builder()
                ...
                .departmentId(
                        module.getDepartment() != null ? module.getDepartment().getId() : null)
                .departmentName(
                        module.getDepartment() != null ? module.getDepartment().getName() : null)
                .teacherIds(
                        module.getTeachers() != null
                                ? module.getTeachers().stream().map(t -> t.getId()).toList()
                                : List.of())
                .build();
    }
